...
public class Product_verify_page_action {
	...
	public void Product_ZtoA(DataTable dataTable){
		...
		WebElement product_dd1 = base.getDriver().findElement(By.xpath("//select[@class='product_sort_container']"));
	...
	public void Prodyuct_verify() {
		...
		String s1 = base.getDriver().getCurrentUrl();
	...
	public void Click_checkout(){
		...
		checkout.click();
		String s2 = base.getDriver().getCurrentUrl();
